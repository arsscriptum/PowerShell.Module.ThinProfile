...
```
New-DelayedScheduledTask [-ScriptPath] <String> [-TaskName <String>] [-Seconds <Int32>] [-UseProfile] [-UseVbs]
 [-User <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
